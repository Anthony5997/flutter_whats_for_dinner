                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: SelectFormField(
                                      ...
                                      // initialValue: widget.ingredients_list[widget.index].unit_name,
                                      labelText: 'Unitée',
                                      changeIcon: true,
                              ...
                              onPressed: () async {
                                if (formKey.currentState?.validate() == true) {
                                  ...
                                  setState(() {
                                    ...
                                    if (_valueChanged == "1") {
                                      widget.ingredients_list[widget.index].unit_name = "g";
                                    } else if (_valueChanged == "2") {
                                      widget.ingredients_list[widget.index].unit_name = "kg";
                                    } else if (_valueChanged == "3") {
                                      widget.ingredients_list[widget.index].unit_name = "cl";
                                    } else if (_valueChanged == "4") {
                                      widget.ingredients_list[widget.index].unit_name = "l";
                                    } else if (_valueChanged == "5") {
                                      widget.ingredients_list[widget.index].unit_name = "unitée(s)";
                                    }
                                    _visibility = false;
                                  });
                                  ScaffoldMessenger.of(context).showSnackBar(CustomSnackBar(context, "Quantitée modifiée", Colors.green));
                                }
                              },
                            ),
                          ],
